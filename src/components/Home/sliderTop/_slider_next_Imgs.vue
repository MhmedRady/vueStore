<template>
    <div class="row wpb_row row-fluid  mb-0">
        <div class="col-sm-6 mb-0 banner-top-left wpb_column column_container">
        ...
        <div class="col-sm-6 banner-top-right wpb_column column_container">
            <div class="wpb_single_image wpb_content_element mb-15 mb-xs-30 align_center">
                <div class="wpb_wrapper">
                    <router-link to="/" target="_self">
